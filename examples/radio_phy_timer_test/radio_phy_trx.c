...
int main()
{
    ...
    res = phyRadioTimerStartCombinedTimer(&my_instance.phy_radio_inst.tdma_scheduler.frame_sync.radio_timer, tick_timer_callback, new_frame_callback, PHY_RADIO_FRAME_TIME_US, PHY_RADIO_SLOT_GUARD_TIME_US, 0);
